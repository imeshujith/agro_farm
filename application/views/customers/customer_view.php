                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php if($customer->active == true) { ?>
                                            <a href="<?php echo base_url(); ?>customers/customer/inactive_customer?id=<?php echo $customer->id; ?>"><span class="label label-success">Active</span></a>
                                        <?php } else { ?>
                                            <a href="<?php echo base_url(); ?>customers/customer/active_customer?id=<?php echo $customer->id; ?>"><span class="label label-danger">Inactive</span></a>
                                        <?php } ?>
                                    </td>
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="radio-inline"><input type="radio" name="customer_type" id="customer_person" value="person" checked data-validation="required">Person</label>
                                                <label class="radio-inline"><input type="radio" name="customer_type" id="customer_company" value="company" data-validation="required">Company</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label id="customer_label">First Name</label>
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="radio-inline"><input type="radio" name="customer_type" id="update_customer_person" value="person" data-validation="required">Person</label>
                                                <label class="radio-inline"><input type="radio" name="customer_type" id="update_customer_company" value="company" data-validation="required">Company</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label id="update_customer_label">First Name</label>
