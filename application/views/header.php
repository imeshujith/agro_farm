...
<div class="wrapper">
    ...
    <header class="main-header fixed">
        <!-- Logo -->
        <a href="<?php if($this->session->userdata('type') != 'Sales Person') { echo base_url('home'); } ?>" class="logo">
        ...
        <nav class="navbar navbar-static-top">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>users/UserProfile"> <i class="fa fa-user-circle" style="margin-right: 3px; vertical-align: bottom; font-size: 18px;"></i> <?php echo $this->session->userdata('name') ;?> | <?php echo $this->session->userdata('type') ;?></a>
                    </li>
                    <li>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    <a href="#">
                        ...
                        <ul class="treeview-menu">
                            <li <?php if($this->session->userdata('type') == 'Admin') { ?>><a href="<?php echo base_url(); ?>users/users"><i class="fa fa-angle-right"></i> Users</a></li><?php } ?>
